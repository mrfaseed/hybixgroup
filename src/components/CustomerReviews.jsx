...
const CustomerReviews = () => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      role: "VP Operations, NextGen Corp",
      rating: 5,
      review: "Outstanding work from start to finish! The Hybix Group team was responsive, creative, and delivered a solution that perfectly fits our needs. Their expertise is world-class.",
      avatar: "SM",
    ...
    },
    {
      ...
      rating: 5,
      review: "Hybix Group's innovative solutions and professional execution made our project a huge success. They're not just service providers, they're true partners in growth.",
      avatar: "RT",
    ...
    },
    {
      id: 9,
      name: "Amanda Foster",
      role: "Chief Strategy Officer, Visionary Inc",
      rating: 5,
      review: "The best decision we made was partnering with Hybix Group. Their strategic thinking combined with technical prowess delivered results that transformed our business.",
      avatar: "AF",
    ...
    <div className="customer-reviews-section">
      ...
      <div className="reviews-grid">
        {reviews.map((review, index) => (
          <div
            key={review.id}
            className={`review-card ${isVisible ? 'visible' : ''} ${activeCard === review.id ? 'expanded' : ''}`}
            style={{ animationDelay: `${index * 0.1}s` }}
            onClick={() => setActiveCard(activeCard === review.id ? null : review.id)}
          >
            {/* Card Glow Effect */}
